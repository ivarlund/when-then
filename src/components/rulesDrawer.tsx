import { Card, Container, Divider, Drawer, Paper, Typography } from "@mui/material";
import { useState } from "react";

export default function RulesDrawer({ isOpen, setIsOpen }: { isOpen: boolean, setIsOpen: (open: boolean) => void }) {
    ...
    return (
        <Drawer anchor="top" variant="temporary" open={isOpen} onClose={toggleDrawer(false)}>
